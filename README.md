 В папке "Снимки библиотек" находятся скриншоты установленного окружения Python 3.6 в conda, а также снимки со списком всех библиотек(файл с pytorch называется packages8).
